export const projects = [
  // Commercial Malls
  { name: 'The Dubai Mall', category: 'Commercial', location: 'Dubai', featured: true },
  { name: 'Circle Mall', category: 'Commercial', location: 'Dubai', featured: true },
  { name: 'Yas Mall', category: 'Commercial', location: 'Abu Dhabi', featured: true },
  { name: 'Nakheel Mall', category: 'Commercial', location: 'Dubai', featured: true },
  { name: 'Taif Mall', category: 'Commercial', location: 'Fujairah', featured: false },
  { name: 'Jimi Mall', category: 'Commercial', location: 'Al Ain', featured: false },

  // Hotels & Hospitality
  { name: 'Kempinski Hotel', category: 'Hospitality', location: 'Dubai', featured: true },
  { name: 'The Edition Hotel', category: 'Hospitality', location: 'Dubai', featured: true },

  // Corporate & Government
  { name: 'ADNOC Headquarters', category: 'Corporate', location: 'Abu Dhabi', featured: true },
  { name: 'Al Dar Properties', category: 'Corporate', location: 'Abu Dhabi', featured: true },

  // Developers
  { name: 'Emaar Properties', category: 'Developer', location: 'Dubai', featured: true },
  { name: 'Dubai Properties', category: 'Developer', location: 'Dubai', featured: true },

  // Healthcare
  { name: 'Sheikh Khalifa Hospital', category: 'Healthcare', location: 'Abu Dhabi', featured: true },
  { name: 'Mediclinic Hospitals', category: 'Healthcare', location: 'UAE', featured: true },
