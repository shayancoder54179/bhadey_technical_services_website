...
const oversizedCargoPageData: ServicePageData = {
  ...
  equipment: {
    ...
    description:
      "Bhadeya Technical combines a professional escort fleet — certified escort vehicles, trained flagmen, and on-site technicians — with our industry-leading Proceq GP8000 and GS8000 GPR scanning equipment. This unique combination means we can assess the structural capacity of bridges and roads along your route before the load moves, ensuring no surprises on the day. It is the most comprehensive oversized cargo support service available in the UAE.",
    specs: [
      { label: "Coverage", value: "All UAE Emirates" },
      { label: "Compliance", value: "RTA & UAE Authorities" },
      { label: "Route scanning", value: "Proceq GP8000 / GS8000" },
  ...
  process: {
    ...
    steps: [
      ...
      },
      {
        ...
        description:
          "For bridges or road sections where structural capacity needs to be verified, our GPR team conducts a pre-movement scan using the Proceq GP8000 or GS8000. Results are documented and reviewed before the load moves.",
      },
      {
        number: 5,
  ...
  seoParagraphs: [
    ...
    },
    {
      ...
      content:
        "What makes Bhadeya Technical unique among UAE oversized cargo support providers is our GPR scanning capability. Before a heavy load passes over a bridge or section of road, we can assess the subsurface structural condition using our Proceq GP8000 or GS8000 ground penetrating radar. This gives clients and logistics teams verified confidence that the infrastructure can safely support the load — something no other UAE provider can offer as part of an integrated cargo movement service.",
    },
  ],
  peopleAlsoAsk: [
    {
